...
class MiApp(QMainWindow):
    def __init__(self):
        ...
        self.ui.graph1.addWidget(self.grafica)
        self.ui.graph2.addWidget(self.grafica1)
        self.ui.graph3.addWidget(self.grafica2)
        self.ui.graph4.addWidget(self.grafica3)
